...
public interface ExchangeRateQueries {
	...
	public static final String CREATE_EXCHANGE_RATE = """
		INSERT INTO ExchangeRates (Rate, BaseCurrencyID, TargetCurrencyID)
	...
	public static final String UPDATE_EXCHANGE_RATE = """
